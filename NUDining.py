...
=======
         'SATURDAY': [10, '30', 'AM', 24, '00', 'PM'],
>>>>>>> 70f697ac0ea7d36758d96684edd20c8faaf89962
...
NORMAL_LOCATIONS = {('INTERNATIONAL VILLAGE', 'IV'): IV, ('STETSON EAST', 'STEAST'): STEAST,
                    ('STETSON WEST', 'STWEST'): STWEST, ('OUTTAKES', 'OUTTAKES'): OUTTAKES,
                    ('KIGO KITCHEN', 'KIGO'): KIGO, ('POPEYES LOUSIANA KITCHEN', 'POPEYES KITCHEN', 'POPEYES'): POPEYES,
                    ("REBECCA'S", 'REBECCAS'): REBECCAS, ('STARBUCKS', 'STARBUCKS'): STARBUCKS,
                    ('SUBWAY', 'SUBWAY'): SUBWAY, ('UBURGER', 'UBURGER'): UBURGER,
                    ('QDOBA', 'QDOBA'): QDOBA, ("AMELIA'S", 'AMELIAS'): AMELIAS,
...
MLK_LOCATIONS = {('INTERNATIONAL VILLAGE', 'IV'): IV_MARTIN, ('STETSON EAST', 'STEAST'): STEAST_MARTIN,
                 ('STETSON WEST', 'STWEST'): STWEST_MARTIN, ('OUTTAKES', 'OUTTAKES'): OUTTAKES_MARTIN,
                 ('KIGO KITCHEN', 'KIGO'): KIGO_MARTIN, ('POPEYES LOUSIANA KITCHEN', 'POPEYES KITCHEN', 'POPEYES'): POPEYES_MARTIN,
