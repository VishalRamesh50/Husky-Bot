...
sys.path.append("src")
from cogs.hours.hours_model import HoursModel  # noqa: E402
from data import nu_dining  # noqa: E402

hours_model_path = "cogs.hours.hours_model"
...
class TestSetTodaysLocation(unittest.TestCase):
    ...
    @patch(f"{hours_model_path}.datetime")
    def test_set_todays_location_during_special_range(self, datetime_mock):
        ...
        self.assertEqual(
            self.model.date_name, " **(Winter Intersession 1: Dec 14-20,2019)**"
        )
    ...
    @patch(f"{hours_model_path}.datetime")
    def test_set_todays_location_during_special_range_end_date_midday(
        self, datetime_mock
    ):
        set_date(datetime_mock)
    ...
    def test_passing_in_date_different_than_now(self, datetime_mock):
        ...
        self.assertEqual(
            self.model.date_name, " **(Winter Intersession 2: Dec 21-27,2019)**"
        )
...
class TestValidLocation(unittest.TestCase):
    ...
    @patch(f"{hours_model_path}.datetime")
    def test_recognized_location_alias_lowercase_with_special_chars(
        self, datetime_mock
    ):
        set_date(datetime_mock)
...
class TestObtainHoursKeyValue(unittest.TestCase):
    ...
    def test_spring_break_friday_stwest(self, datetime_mock):
        ...
        self.assertEqual(
            self.obtain_hours_key_value("STETSON WEST", "FRIDAY"), expected
        )
    ...
    def test_current_date_normal_next_day_special(self, datetime_mock):
        ...
        self.assertNotEqual(
            self.obtain_hours_key_value("IV", "FRIDAY"), ("F", [7, 00, 21, 00])
        )
    ...
    def test_holiday1_to_holiday2(self, datetime_mock):
        ...
        expected = ("R", [8, 0, 15, 0])
        self.assertEqual(
            self.obtain_hours_key_value("STETSON WEST", "THURSDAY"), expected
        )
    ...
    def test_holiday2_to_normal(self, datetime_mock):
        ...
        self.assertEqual(
            self.obtain_hours_key_value("STETSON WEST", "MONDAY"), expected
        )
    ...
    def test_whitespace_between_location(self, datetime_mock):
        set_date(datetime_mock)
        self.assertRaises(
            AssertionError, self.obtain_hours_key_value, "S TE A ST", "FRIDAY"
        )
    ...
    def test_whitespace_between_day(self, datetime_mock):
        set_date(datetime_mock)
        self.assertRaises(
            AssertionError, self.obtain_hours_key_value, "STEAST", "F R ID AY"
        )
...
class TestObtainDayRange(unittest.TestCase):
    ...
    def test_whitespace_around_and_between_days(self):
        self.assertEqual(
            self.obtain_day_range("  U   W  ", "SUNDAY"), "SUNDAY-WEDNESDAY"
        )
...
class TestLocationHoursMsg(unittest.TestCase):
    ...
    def test_stwest_closed_holiday(self, datetime_mock):
        ...
        day = "sunday"
        expected = (
            "STWEST is CLOSED EVERYDAY **(Winter Intersession 2: Dec 21-27,2019)**"
        )
        self.assertEqual(self.model.location_hours_msg(location, day), expected)
...
class TestConvertToDatetime(unittest.TestCase):
    ...
    def test_same_day(self, datetime_mock):
        ...
        self.assertEqual(
            self.convert_to_datetime(20, 30, "SATURDAY"), datetime(2019, 11, 23, 20, 30)
        )
    ...
    def test_yesterday_normal_range(self, datetime_mock):
        ...
        datetime_mock.now = Mock(return_value=datetime(2019, 11, 23, 16, 30))
        self.assertEqual(
            self.convert_to_datetime(20, 30, "FRIDAY"), datetime(2019, 11, 22, 20, 30)
        )
    ...
    def test_yesterday_next_day_range(self, datetime_mock):
        ...
        datetime_mock.now = Mock(return_value=datetime(2019, 11, 23, 16, 30))
        self.assertEqual(
            self.convert_to_datetime(25, 30, "FRIDAY"), datetime(2019, 11, 23, 1, 30)
        )
    ...
    def test_two_days_behind_normal_range(self, datetime_mock):
        ...
        datetime_mock.now = Mock(return_value=datetime(2019, 11, 23, 16, 30))
        self.assertEqual(
            self.convert_to_datetime(20, 30, "THURSDAY"), datetime(2019, 11, 28, 20, 30)
        )
    ...
    def test_yesterday_next_day_range_index_0_today(self, datetime_mock):
        ...
        datetime_mock.now = Mock(return_value=datetime(2019, 11, 24, 16, 30))
        self.assertEqual(
            self.convert_to_datetime(25, 30, "SATURDAY"), datetime(2019, 11, 24, 1, 30)
        )
    ...
    def test_valid_day_acronym(self, datetime_mock):
        ...
        datetime_mock.now = Mock(return_value=datetime(2019, 11, 24, 16, 30))
        self.assertEqual(
            self.convert_to_datetime(1, 30, "SAT"), datetime(2019, 11, 23, 1, 30)
        )
    ...
    def test_0_minutes(self, datetime_mock):
        ...
        datetime_mock.now = Mock(return_value=datetime(2019, 11, 24, 16, 30))
        self.assertEqual(
            self.convert_to_datetime(25, 0, "SATURDAY"), datetime(2019, 11, 24, 1, 0)
        )
...
class TestIsOpen(unittest.TestCase):
    ...
    @patch(f"{hours_model_path}.datetime")
    def test_location_closed_entire_current_day_would_be_open_yesterday(
        self, datetime_mock
    ):
        set_date(datetime_mock)
    ...
    @patch(f"{hours_model_path}.datetime")
    def test_location_closed_entire_current_day_yesterday_data_closed(
        self, datetime_mock
    ):
        set_date(datetime_mock)
...
class TestGetLink(unittest.TestCase):
    ...
    @patch(f"{hours_model_path}.datetime")
    def test_get_special_link_from_different_range_than_current_date(
        self, datetime_mock
    ):
        set_date(datetime_mock)
        # Mock Date: Jan 1, 2018 (Monday)
