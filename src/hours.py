...
class Hours(commands.Cog):
    ...
    async def hours(self, ctx, *args):
        ...
        await ctx.send("*Hours may not be accurate for Winter Break (Dec 21-27,2019)*", delete_after=5)
        await ctx.author.send("Check here for updated hours:\nhttps://nudining.com/files/images/aa3811ba-68c6-4835-a19c-ba3bdae5e210.jpg")
