...
class Hours(commands.Cog):
    ...
    async def hours(self, ctx, *args):
        await ctx.send('This command is currently out of order. You can use it when the hours are updated.', delete_after=5)
        await ctx.send('Take a look at the actual hours here: https://nudining.com/hours')
